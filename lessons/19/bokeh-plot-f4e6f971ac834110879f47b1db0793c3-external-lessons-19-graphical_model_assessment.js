(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("8378c9f1-a56b-4d06-9294-e087307b3263");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '8378c9f1-a56b-4d06-9294-e087307b3263' but no matching script tag was found.")
        }
