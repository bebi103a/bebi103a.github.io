(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("caadb95f-3d4a-40dc-a52b-e839f8322745");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'caadb95f-3d4a-40dc-a52b-e839f8322745' but no matching script tag was found.")
        }
